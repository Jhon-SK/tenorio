...
class Vc_Vendor_AdvancedCustomFields implements Vc_Vendor_Interface {
	...
	public function load() {
		 ...
		 * @see Vc_Backend_Editor::renderEditor public/plugins/js_composer/include/classes/editors/class-vc-backend-editor.php
		 */
		 ...
		 * @see Vc_Frontend_Editor::renderEditor public/plugins/js_composer/include/classes/editors/class-vc-frontend-editor.php
		 */
