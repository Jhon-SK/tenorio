...
class VideoPress_Player {
	...
	function html5_dynamic_next() {
		...
		if ( $iframe_embed ) {
			...
			$js_url = 'https://s0.wp.com/public/plugins/video/assets/js/next/videopress-iframe.js';
			...
			$js_url             = 'https://s0.wp.com/public/plugins/video/assets/js/next/videopress.js';
