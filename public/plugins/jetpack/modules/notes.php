...
class Jetpack_Notifications {
	...
	public function styles_and_scripts() {
		...
		if ( ! wp_script_is( 'underscore', 'registered' ) ) {
			wp_register_script( 'underscore', $this->wpcom_static_url( '/public/js/underscore.min.js' ), null, JETPACK_NOTES__CACHE_BUSTER, true );
		}
		$script_handles[] = 'underscore';
		if ( ! wp_script_is( 'backbone', 'registered' ) ) {
			wp_register_script( 'backbone', $this->wpcom_static_url( '/public/js/backbone.min.js' ), array( 'underscore' ), JETPACK_NOTES__CACHE_BUSTER, true );
		}
